            ...
            <div className="cyber-border p-6 rounded-sm bg-cyber-blue/20 backdrop-blur-sm h-full">
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  ...
                  <a 
                    href="#" 
                    className="w-10 h-10 border border-cyber-yellow/50 rounded-sm flex items-center justify-center text-cyber-yellow hover:bg-cyber-yellow hover:text-cyber-dark-blue transition-colors duration-300"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
