    ...
    <footer className="bg-black py-10 border-t border-cyber-neon/10">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <button 
            onClick={scrollToTop}
            className="w-10 h-10 rounded-sm bg-black border-cyber-neon/30 border flex items-center justify-center text-cyber-neon hover:bg-cyber-neon hover:text-black transition-colors duration-300"
          >
